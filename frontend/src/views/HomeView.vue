<template>
  <div class="home-view">
    ...
    <section class="modules-grid">
      ...
      <router-link v-if="hasAccessTo.finanzas" to="/finanzas" class="module-card secondary">
        <div class="card-icon">
        ...
        <span class="btn-text">Ver Balance &rarr;</span>
      </router-link>

      <router-link v-if="hasAccessTo.asistencia_dashboard" to="/asistencia" class="module-card primary">
        <div class="card-icon">
        ...
        <span class="btn-text">Ver Analíticas &rarr;</span>
      </router-link>
    </section>
  </div>
</template>
